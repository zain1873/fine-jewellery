...
import product1 from '../images/wedding-rings.webp';


const WeddingRingsCards = () => {
  const products = [
    {
      id: 1,
  ...
  return (
    <div className="chanel-recommendations py-lg-5 py-3 top" data-aos="fade-bottom" data-aos-delay="300" data-aos-duration="1000">
      <div className="container">
        <h2 className="section-title mb-4 text-center">Wedding Rings</h2>
...
export default WeddingRingsCards;
