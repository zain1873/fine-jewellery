...
import bannerImg from "../images/bracelets.webp";
import BracelletsCards from '../components/BracelettsCards';
    ...
    <Parent>
        ...
        <div class="banner-info">
          ...
          <div class="banner-info p-lg-3 py-2">
              <h1 className="mb-4 banner-text left">Braceletts</h1>
